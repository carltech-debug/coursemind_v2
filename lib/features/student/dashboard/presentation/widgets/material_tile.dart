...
DESCRIPTION
-----------
Displays a recently accessed course material.

CURRENT PHASE
-------------
Presentation-only.

Material opening functionality will be connected when the learning-material
data and navigation layers are implemented.
